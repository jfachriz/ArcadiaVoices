...
NOTARIZE_BUNDLE_ID=com.ArchangelDSP.ArcadiaVoices
NOTARIZE_BUNDLE_ID_DEMO=com.ArchangelDSP.ArcadiaVoices.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/ArcadiaVoices.iss
#  git checkout installer/ArcadiaVoices.pkgproj
