...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=ArcadiaVoices Demo Installer\n"
      else:
        line="OutputBaseFilename=ArcadiaVoices Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the ArcadiaVoices Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the ArcadiaVoices installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=ArcadiaVoices Demo installer\n"
     else:
       line="SetupWindowTitle=ArcadiaVoices installer\n"
